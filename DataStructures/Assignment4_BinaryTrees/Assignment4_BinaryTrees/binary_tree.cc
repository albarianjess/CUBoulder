...
int SizeRecursive(const BinaryTreeNode* tree_node) {
  ...
  if (tree_node == NULL){
    ...
    count = count + SizeRecursive(tree_node->left_child);
    count = count + SizeRecursive(tree_node->right_child);
    return count;
  }
  return -1;
}
...
bool ContainsRecursive(const BinaryTreeNode* tree_node, int value) {
  ...
  if (tree_node == NULL){
    return false;
  } else if (SizeRecursive(temp, value){
    return true;
  }
...
bool InsertRecursive(BinaryTreeNode* tree_node, int value) { return false; }
...
bool RemoveRecursive(BinaryTreeNode*& tree_node, int value) { return false; }
...
// this.
bool BinaryTree::Contains(int value) { return false; }
...
bool BinaryTree::Insert(int value) { return false; }
